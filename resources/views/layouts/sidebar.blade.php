<!-- Sidebar -->
<div id="sidebar"
    class="fixed inset-y-0 left-0 z-20 w-72 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 ease-in-out pt-16">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-4 py-6 space-y-3 overflow-y-auto">
            ...
            <!-- Help -->
            <a href="#"
                class="sidebar-link group flex items-center px-4 py-3 text-base font-medium rounded-lg text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 relative"
                title="{{ __('Help') }}">
